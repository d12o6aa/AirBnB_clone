...
class TestDocuemntationOfAll(unittest.TestCase):
    ...
    def test_module_doc(self):
        ...
        """
        boolVal = len(City.__module__.__doc__) > 1
    ...
    def test_init_doc(self):
        ...
        Test if module documentation exists
        """
        boolVal = len(City.__init__.__doc__) > 1
        self.assertTrue(boolVal)
    ...
    def test_str_doc(self):
        ...
        Test if module documentation exists
        """
        boolVal = len(City.__str__.__doc__) > 1
        self.assertTrue(boolVal)
    ...
    def test_save_doc(self):
        ...
        Test if module documentation exists
        """
        boolVal = len(City.save.__doc__) > 1
        self.assertTrue(boolVal)
    ...
    def test_to_dict_doc(self):
        ...
        Test if module documentation exists
        """
        boolVal = len(City.to_dict.__doc__) > 1
        self.assertTrue(boolVal)
...
class TestClassAttributes(unittest.TestCase):
    ...
    def test_Inherited_attributes(self):
        ...
        """
        self.assertEqual(City.id.__class__, str)
        self.assertEqual(City.created_at.__class__, datetime)
        self.assertEqual(City.updated_at.__class__, datetime)
    ...
    def test_is_public(self):
        ...
        """
        obj = City()
        obj.state_id = "32432LA"
        obj.name = "LA"
        self.assertEqual(obj.name, "LA")
        self.assertEqual(obj.state_id, "32432LA")

    def test_nonInherited_attributes(self):
        """
        testing each City object attribute's type
        """
        self.assertEqual(City.name.__class__, str)
        self.assertEqual(City.state_id.__class__, str)
...
class TestConstructorMethod(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.Obj1 = City()
        self.Obj2 = City()
        self.ObjKw1 = City(name="test")
        self.ObjKw2 = City(name="test", value=98)
        created_at = "2017-09-28T21:05:54.119427"
        updated_at = "2023-09-28T21:05:54.119427"
        self.Objdt = City(created_at, updated_at)
