#!/usr/bin/python3
"""
Testing the review model by unittest
"""
...
class TestClassAttributes(unittest.TestCase):
    ...
    def test_Inherited_attributes(self):
        ...
        """
        self.assertEqual(Review.id.__class__, str)
        self.assertEqual(Review.created_at.__class__, datetime)
        self.assertEqual(Review.updated_at.__class__, datetime)

    def test_is_public(self):
        """
        Test whether attrs is public
        """
        obj = Review()
        obj.place_id = "31LA"
        self.assertEqual(obj.place_id, "31LA")
        obj.user_id = "31LA"
        self.assertEqual(obj.user_id, "31LA")
        obj.text = "31LA"
        self.assertEqual(obj.text, "31LA")

    def test_nonInherited_attributes(self):
        """
        testing each Review object attribute's type
        """
        self.assertEqual(Review.place_id.__class__, str)
        self.assertEqual(Review.user_id.__class__, str)
        self.assertEqual(Review.text.__class__, str)
...
class TestConstructorMethod(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.Obj1 = Review()
        self.Obj2 = Review()
        self.ObjKw1 = Review(name="test")
        self.ObjKw2 = Review(name="test", value=98)
        created_at = "2017-09-28T21:05:54.119427"
        updated_at = "2023-09-28T21:05:54.119427"
        self.Objdt = Review(created_at, updated_at)
