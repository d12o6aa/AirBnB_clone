#!/usr/bin/python3
"""
Testing the State model by unittest
"""
...
class TestClassAttributes(unittest.TestCase):
    ...
    def test_Inherited_attributes(self):
        ...
        """
        self.assertEqual(State.id.__class__, str)
        self.assertEqual(State.created_at.__class__, datetime)
        self.assertEqual(State.updated_at.__class__, datetime)
    ...
    def test_nonInherited_attributes(self):
        """
        testing each State object attribute's type
        """
        self.assertEqual(State.name.__class__, str)
...
class TestConstructorMethod(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.Obj1 = State()
        self.Obj2 = State()
        self.ObjKw1 = State(name="test")
        self.ObjKw2 = State(name="test", value=98)
        created_at = "2017-09-28T21:05:54.119427"
        updated_at = "2023-09-28T21:05:54.119427"
        self.Objdt = State(created_at, updated_at)
